...
class Find extends JDialog implements ActionListener {
	...
	public Find(JFrame parent, JTextArea ta) {
		...
		add(lFind); add(lReplace); add(tFind); add(tReplace); add(bFind); add(bReplace);
		setResizable(false);
	...
	public void showFind() {
		setTitle("찾기"); setSize(400,120); setLocation(400, 300); setVisible(true);
	}
	public void showReplace() {
		setTitle("찾아 바꾸기"); this.setLocationRelativeTo(this.getParent()); setSize(400,200); setVisible(true);
	}
